<template>
    <UContainer>
        <v-card variant="plain" class="mx-auto my-4" max-width="800">
            <v-card-item>
        ...
        <v-card v-for="experience in Experiences" :key="experience.title" variant="tonal" class="mx-auto my-4"
            max-width="800">

            <v-img :src="experience.image" max-height="200px" cover></v-img>
        ...
        Experiences: [
            {
                ...
                description:
                    "Hybrid technical and customer facing role working to improve mechanic & quality engineering efficiency for the Boeing F-15 Fighter program. \
                    Engineered fullstack Spark and Foundry solutions to achieve 99% improvement in IE training plan creation. Collaborated to design complex data models spanning aircraft data, bill of materials, and work history to provide insights into production downtime stats and quality escape root causes. \
                    Designed, implemented, and validated python + scikit data science workflows (regression, random forest, etc), then productionized them in Foundry as API-accessible modeling objectives, enabling scalable integration into downstream applications. \
                    Built a custom React app in Foundry integrating ontology data with OSDK to deliver real-time manufacturing status visibility for F-15 executive leadership, and developed a Foundry AI Platform workflow leveraging LLMs to automate mechanic job classification from job descriptions. \
                    Successfully converted this pilot into a multi-million $ extension contract.",
                show: false,
            ...
            },
            {
                ...
                company:
                    "Amazon Robotics",
                description:
                    "Innovated in tote palletization process by exploring the Mixed Reality space for efficiency improvements and data flow visualization opportunities. Designed, developed, and tested a mixed reality application for the Microsoft HoloLens 2. Integrated the HoloLens 2 device with AWS for a cloud based infrastructure. Demoed results and garnered key stakeholder interest for future development opportunities in the Mixed Reality Fulfillment Center space.",
                show: false,
            },
            {
            ...
            {
                title: "SDE Intern - Cybersecurity and Automation",
            ...
            {
                title: "SDE Intern - Web Development",
